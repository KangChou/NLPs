...
# ck:https://stackoverflow.com/questions/67703817/cant-import-plot-model-from-keras-utils
...
def load_data(filepath, input_shape=20):
    ...
    with open('models/label_dict.pk', 'wb') as f:
...
def create_LSTM(n_units, input_shape, output_dim, filepath):
    ...
    plot_model(model, to_file='train_png_result/model_lstm.png', show_shapes=True)
    model.summary()
...
if __name__ == '__main__':
    filepath = './datasets/data_single.csv'
    input_shape = 180
